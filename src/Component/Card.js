...
export const Card = ({ pelis}) => {
  ...
  return ( pelis &&
   ...
   <div className="yearPleis"><p className="yearCartel">{pelis.pelis.years}</p><p className={pelis.pelis.series ? "serieCartel" : 'peliCartel'}>{pelis.pelis.series ? 'SERIE' : 'PELICULA'}</p></div>
